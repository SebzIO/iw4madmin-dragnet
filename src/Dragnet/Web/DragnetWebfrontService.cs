...
""");
        ...
        int? count = null)
    {
        ...
        if (count is not null)
        {
            ...
            if (targetId.Equals("dragnet-notification-modal", StringComparison.OrdinalIgnoreCase))
            {
                html.Append(" data-dragnet-notification-count=\"true\"");
            }
            html.Append(">");
